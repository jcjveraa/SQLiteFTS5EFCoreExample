...
{
    public partial class subset_track_metadataContext : DbContext
    {
        public subset_track_metadataContext()
        {
        }

        public subset_track_metadataContext(DbContextOptions<subset_track_metadataContext> options)
            : base(options)
        {
        }
